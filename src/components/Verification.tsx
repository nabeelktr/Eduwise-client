...
const Verification: React.FC<Props> = ({setRoute}) => {
    ...
    const VerificationHandler = async () => {
        ...
        console.log(verificationNumber, token);
    ...
    <div>
        ...
        <div className=' m-auto flex items-center justify-around p-4'>
            {Object.keys(verifyNumber).map((key, index) => (
                ...
                key={key}
                ref={inputRefs[index]}
                className={`w-[55px] h-[55px] bg-transparent border-[3px] rounded-[10px] flex items-center text-black dark:text-white justify-center text-[16px] font-Poppins outline-none text-center ${
                    invalidError 
